...
- server install apply: `POST /api/update/apply`
- client install apply: `POST /update/apply`
...
- manual apply downloads, verifies, installs, and switches `current` to the new release without restarting automatically
