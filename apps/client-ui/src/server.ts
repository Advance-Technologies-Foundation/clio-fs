  ...
  <dialog id="shutdown-confirm-dialog" class="dialog">
    <div class="modal-card">
      <div class="modal-header">
        ...
        <button class="modal-close" type="button" onclick="document.getElementById('shutdown-confirm-dialog').close()" aria-label="Close">×</button>
      </div>
      <div class="modal-body">
        <p class="lede" style="margin-top:0;">Stop the client UI process and close it?</p>
      </div>
      <div class="modal-actions">
        <button class="secondary-button" type="button" onclick="document.getElementById('shutdown-confirm-dialog').close()">Cancel</button>
