...
- [x] Item 4. Add version/update widgets to server and client UI with `Check for updates`.
- [x] Item 5. Document manual update discovery flow and compatibility rules.
